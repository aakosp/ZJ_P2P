...
public class CustomText extends TextView {
    ...
    private void init() {
        ...
        CustomText.DEFAULT_ABSOLUTE_TEXT_SIZE = (int) getTextSize();
    }

    /**
     * Use this method to add a {@link CustomText.Piece} to a BabushkaText.
     * Each {@link CustomText.Piece } is added sequentially, so the
    ...
    /**
     * Get a specific {@link CustomText.Piece} in position index.
     *
    ...
    /**
     * Call this method when you're done adding {@link CustomText.Piece}s
    ...
    */
     ...
     *
     * You create a Piece by using it's {@link CustomText.Piece.Builder}
     *
     */
    public static class Piece {
        ...
        public static class Builder {
            ...
            /**
             * Creates a {@link CustomText.Piece} with the customized
             * parameters.
             *
             * @return a Piece
             */
